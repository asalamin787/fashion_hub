            ...
            <div style="margin-top: 20px; background: #FEFCF8; border: 1px solid #E9E2D6; padding: 16px 24px;">
                <div style="display: flex; justify-content: flex-end;">
                    <div style="min-width: 220px; text-align: right;">
                        ...
                        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;"><span
                            style="color:#6F5E4D;">Coupon Discount @if($order->coupon_code) ({{ $order->coupon_code }}) @endif</span> <strong style="color:#c0392b;">-${{ number_format($order->coupon_discount_amount, 2) }}</strong></div>
                        @endif
                        @if($order->first_order_discount_amount > 0)
                        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;"><span
                            style="color:#6F5E4D;">First Order Discount ({{ number_format((float) $order->first_order_discount_rate, 0) }}%)</span> <strong style="color:#c0392b;">-${{ number_format($order->first_order_discount_amount, 2) }}</strong></div>
                        @endif
